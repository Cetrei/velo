...
const MESSAGES: Record<LogMessage, string> = {
  ...
  [LogMessage.RoomJoined]: '[SIGNALING] Peer {peerId} ({deviceName}) joined room {roomId} as {role}',
  ...
  [LogMessage.PeerDisconnected]: '[SIGNALING] Peer {peerId} ({deviceName}) disconnected from room {roomId}',
